        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body card-main-three">
                    ...
                    <form class="form-floating" action="{{ route('history_edit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="mb-4">
                            <span class="form-floating">
                                ...
                                <input type="file" class="form-control" id="emailInput"  placeholder="password" name="image" value="{{$history->image}}">
                        ...
                        <span class="">
                            ...
                            <textarea class="form-control" id="TextArea" rows="8" cols="30" required placeholder="Comment" name="description" value="">{{$history->description}}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <textarea name="content" required id="summernote" >{!!$history->content!!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
