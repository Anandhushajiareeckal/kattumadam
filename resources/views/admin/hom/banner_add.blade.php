        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body card-main-three">
                    ...
                    <form class="form-floating" action="{{ route('banner_store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <span class="form-floating">
                                ...
                                <label class="form-label" for="TextInput">Banner Description</label>
                            </span>
                        </div>
                        <div class="mb-4">
                            <span class="form-floating">
